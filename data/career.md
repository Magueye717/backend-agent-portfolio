...
Frameworks: Node.js, Nest.js, React.js, Flask, FastAPI, Next.js, Laravel
APIs: REST API, GraphQL
Data & AI: RAG, vector databases, LLMs, pandas, scikit-learn
Cloud & Tools: Docker, GitHub Actions, AWS (EC2, S3, Lambda)
Development: Storybook, Agile/Scrum

# Education
Professional Diploma in Computer Science, National Institute of Information Technology (NIIT), Dakar, Senegal
## Academic Background
I graduated from high school with honors before pursuing Business Law at Gaston Berger University. 
During my studies, I developed a strong interest in technology, which led me to transition into software engineering.
# Certifications
- Full Stack Web Developer — Udacity
- CS50: Introduction to Computer Science — Harvard University
- Java EE & Spring Boot Bootcamp — EDACY (9 months: 3 months theory + 6 months immersion)

# Projects
## Portfolio AI agent (this site)
Built an AI career agent using Flask, RAG with ChromaDB, and React.
...
Open to Full-Stack Developer, Backend Developer, or Frontend Developer roles in fintech, multiservice platforms, or tech consulting. Prefer remote or hybrid. Interested in performance engineering, scalable architecture, and AI-powered applications.
